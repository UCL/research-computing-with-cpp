...
class Smooth {
public:
  Smooth(int sizex = 100, int sizey = 100, distance inner = 21.0, int rank = 0, int mpi_size = 1,
         filling birth_1 = 0.278, filling birth_2 = 0.365, filling death_1 = 0.267,
         filling death_2 = 0.445, filling smoothing_disk = 0.147, filling smoothing_ring = 0.028);
