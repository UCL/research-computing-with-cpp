...
* Factor 10 quicker than rivals

![From wikipedia](session04/figures/CDC6000)
...
![From wikipedia](session04/figures/Cray2)
...
![From wikipedia](session04/figures/480px-IBM_Blue_Gene_P_supercomputer)
...
![From wikipedia](session04/figures/VonNeumannCombined)
...
* Observation: Most algorithm developers/researchers still assuming
    * von Neumann style memory model
...
![From wikipedia](session04/figures/TransistorCount)
...
![From Sutter](session04/figures/CPUPerf)
...
![From M.Jones](session04/figures/realWorldCollage1)
![From M.Jones](session04/figures/realWorldCollage2)
...
![From M.Jones](session04/figures/noaaforcast)
